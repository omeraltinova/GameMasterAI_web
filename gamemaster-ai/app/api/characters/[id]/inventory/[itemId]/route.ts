...
export async function GET(
    ...
    try {
        ...
        const limited = await rateLimitResponse(userId, "GET:/api/characters/[id]/inventory/[itemId]", RATE_LIMIT_TIERS.READ);
...
export async function PUT(
    ...
    try {
        ...
        const limited = await rateLimitResponse(userId, "PUT:/api/characters/[id]/inventory/[itemId]", RATE_LIMIT_TIERS.WRITE);
        if (limited) return limited;
...
export async function DELETE(
    ...
    try {
        ...
        const limited = await rateLimitResponse(userId, "DELETE:/api/characters/[id]/inventory/[itemId]", RATE_LIMIT_TIERS.WRITE);
        if (limited) return limited;
