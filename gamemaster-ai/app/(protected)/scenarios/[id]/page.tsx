...
export default function ScenarioDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="container max-w-7xl py-8 animate-fade-in space-y-8">
      {/* Header */}
      <div className="flex flex-col md:flex-row gap-6 justify-between items-start">
        <div className="space-y-4 flex-1">
          <div className="space-y-2">
            <Button variant="ghost" size="sm" className="-ml-3 gap-2" onClick={() => router.back()}>
              <ArrowLeft className="h-4 w-4" />
              Geri Dön
            </Button>
            <h1 className="text-4xl font-bold tracking-tight">{scenario.title}</h1>
        ...
        <div className="flex flex-col gap-3 w-full md:w-auto">
          <Button size="lg" className="w-full gap-2" onClick={handleStartCampaign}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          ...
          <Card>
             <CardContent className="p-6 space-y-4 bg-muted/30">
               <h2 className="text-lg font-semibold text-muted-foreground">GM Notları (Başlangıç)</h2>
