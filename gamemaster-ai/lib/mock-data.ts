...
export const mockScenarios: Scenario[] = [
  {
    id: "scen_official_1",
    title: "Gri Mendirek: Fenerin Sessizligi",
    description: "Sisli kuzey kiyilarinda yer alan Gri Mendirek kasabasinda deniz feneri uc gecedir yanmiyor. Kaybolan balikcilar, sahile vuran esrarengiz isaretler ve eski bir deniz tanrisinin adinin yeniden fısıldanmasi macerayi baslatir.",
    genre: "Fantasy",
    difficulty: "Medium",
    startingPrompt: "Fenerin tas merdivenlerine adim attigin anda soguk ruzgar yuzu keser. Liman sessiz, dalgalar ise sabirsizdir. Fenerin kalbinden titrek bir isik sızar. Ne yapacaksin?",
    isOfficial: true,
    isAIGenerated: false,
    tags: ["harbor", "mystery", "cult", "storm"],
